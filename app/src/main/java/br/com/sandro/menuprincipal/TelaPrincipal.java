...
public class TelaPrincipal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         * */
        listaJogos.add(new Jogos("Fallout IV - Standart Edition", "Jogos", "", "• RPG", "Bethesda Game Studios", R.mipmap.fallout4_logo, R.mipmap.fallout4_logo, 2, R.mipmap.nao_favorito_icon_foreground, R.mipmap.fallout4_logo, R.mipmap.fallout4_logo, R.mipmap.fallout4_logo, R.mipmap.fallout4_logo, R.mipmap.fallout4_logo, R.mipmap.fallout4_logo));
        listaJogos.add(new Jogos("Super Mario World", "Jogos", "", "• Plataforma  • Ação", "Nintendo Co., Ltd.", R.mipmap.supermario_logo, R.mipmap.supermario_logo, 5, R.mipmap.favorito_icon_foreground, R.mipmap.supermario_logo, R.mipmap.supermario_logo, R.mipmap.supermario_logo, R.mipmap.supermario_logo, R.mipmap.supermario_logo, R.mipmap.supermario_logo));
        listaJogos.add(new Jogos("Grand Theft Auto V", "Jogos", "", "• Ação  • Aventura", "Rockstar North.", R.mipmap.gta5_logo, R.mipmap.gta5_logo, 5, R.mipmap.favorito_icon_foreground, R.mipmap.gta5_logo, R.mipmap.gta5_logo, R.mipmap.gta5_logo, R.mipmap.gta5_logo, R.mipmap.gta5_logo, R.mipmap.gta5_logo));
        listaJogos.add(new Jogos("The last of us", "Jogos", "", "• Ação  • Aventura  • Sobrevivência", "Konami", R.mipmap.tlou_logo, R.mipmap.tlou_logo, 3, R.mipmap.nao_favorito_icon_foreground, R.mipmap.tlou_logo, R.mipmap.tlou_logo, R.mipmap.tlou_logo, R.mipmap.tlou_logo, R.mipmap.tlou_logo, R.mipmap.tlou_logo));
        listaJogos.add(new Jogos("Far Cry 5", "Jogos", "", "• FPS  • Ação", "Ubisoft", R.mipmap.farcry5_logo, R.mipmap.farcry5_logo, 5, R.mipmap.favorito_icon_foreground, R.mipmap.farcry5_1_wallpaper, R.mipmap.farcry5_2_wallpaper, R.mipmap.farcry5_3_wallpaper, R.mipmap.farcry5_4_wallpaper, R.mipmap.farcry5_5_wallpaper, R.mipmap.farcry5_logo));
